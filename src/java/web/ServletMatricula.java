...
"</head>\n" +
"<body>\n" +
"	<div class=\"info\"><table class=\"tabela\">"+
          "			<caption id = \"tbt\">DADOS DO ALUNO</caption>\n" +
                     "<tr class=\"tr\"><td>MATRÍCULA</td><td>NOME</td><td>CURSO</td></tr>"
                    + "<tr class = \"td\"><td>"+a.getMatricula()+"</td><td>"+a.getNome()+"</td><td>"+a.getCurso()+"</td></tr></table></div>\n" +
"	<div class=\"corpo\">\n" +
"		<div class=\"tab\">\n" +
"			<form>\n" +
"		<table class=\"tabela\">\n" +
